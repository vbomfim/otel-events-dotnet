...
public sealed class OtelEventsRateLimitProcessor : BaseProcessor<LogRecord>
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="OtelEventsRateLimitProcessor"/>
    ...
    /// Thrown when <see cref="OtelEventsRateLimitOptions.DefaultMaxEventsPerWindow"/> or
    /// <see cref="OtelEventsRateLimitOptions.Window"/> have invalid values.
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Thrown when <see cref="OtelEventsRateLimitOptions.EventLimits"/> contains
    /// empty keys, a bare wildcard <c>"*"</c>, or negative limit values.
    /// </exception>
    public OtelEventsRateLimitProcessor(
        OtelEventsRateLimitOptions options,
    ...
    /// </summary>
    internal OtelEventsRateLimitProcessor(
        OtelEventsRateLimitOptions options,
        BaseProcessor<LogRecord> innerProcessor,
    ...
    /// </summary>
    private static void ValidateOptions(OtelEventsRateLimitOptions options)
    {
    ...
    /// Falls back to global <see cref="OtelEventsRateLimitOptions.DefaultMaxEventsPerWindow"/>.
    /// </summary>
