...
public sealed class OtelEventsSeverityFilterProcessor : BaseProcessor<LogRecord>
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="OtelEventsSeverityFilterProcessor"/>
    ...
    /// Thrown when <see cref="OtelEventsSeverityFilterOptions.MinSeverity"/> is not a defined enum value.
    /// </exception>
    /// <exception cref="ArgumentException">
    /// Thrown when <see cref="OtelEventsSeverityFilterOptions.EventNameOverrides"/> contains
    /// empty keys or a bare wildcard <c>"*"</c>.
    /// </exception>
    public OtelEventsSeverityFilterProcessor(
        OtelEventsSeverityFilterOptions options,
    ...
    /// </summary>
    private static void ValidateOptions(OtelEventsSeverityFilterOptions options)
    {
    ...
    /// Falls back to global <see cref="OtelEventsSeverityFilterOptions.MinSeverity"/>.
    /// </summary>
