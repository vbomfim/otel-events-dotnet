...
namespace All.Analyzers
{
    ...
    /// event methods. ALL handles message interpolation — pass raw values only.
    /// </summary>
    ...
    public sealed class StringInterpolationAnalyzer : DiagnosticAnalyzer
    {
        ...
        internal static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(
            ...
            description: "String interpolation ($\"...\") passed to an ALL-generated event method parameter. ALL handles message interpolation — pass raw values only.",
