...
namespace All.Analyzers
{
    ...
    public sealed class ExceptionNotCapturedAnalyzer : DiagnosticAnalyzer
    {
        ...
        internal static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(
            ...
            messageFormat: "Caught exception '{0}' is not passed to any event or logging method. Emit an ALL event with the exception.",
            category: "Reliability",
            defaultSeverity: DiagnosticSeverity.Warning,
            isEnabledByDefault: true,
            description: "catch block doesn't emit an ALL event with the caught exception.",
