...
namespace All.Schema;

/// <summary>
/// Provides access to built-in schema definitions embedded in the All.Schema package.
...
public static class BuiltInSchemas
{
    ...
    /// </summary>
    internal const string LifecycleResourceName = "All.Schema.Schemas.lifecycle.all.yaml";
