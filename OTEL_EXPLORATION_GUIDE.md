...
Pack YAML Schema (embedded)
    ↓
OtelEvents.Schema (build-time) → Pre-generated C# code
    ↓
...
<Solution>
  <Folder Name="/src/">
    <Project Path="src/OtelEvents.Analyzers/OtelEvents.Analyzers.csproj" />
    <Project Path="src/OtelEvents.Causality/OtelEvents.Causality.csproj" />
    ...
    <Project Path="src/OtelEvents.Testing/OtelEvents.Testing.csproj" />
  </Folder>
  <Folder Name="/tests/">
    <Project Path="tests/OtelEvents.Analyzers.Tests/OtelEvents.Analyzers.Tests.csproj" />
    <Project Path="tests/OtelEvents.Causality.Tests/OtelEvents.Causality.Tests.csproj" />
...
**All Source Projects:**
1. `OtelEvents.Analyzers/OtelEvents.Analyzers.csproj` - Target: net10.0
2. `OtelEvents.Causality/OtelEvents.Causality.csproj` - Target: net10.0
3. `OtelEvents.Exporter.Json/OtelEvents.Exporter.Json.csproj` - Target: net10.0
4. `OtelEvents.Schema/OtelEvents.Schema.csproj` - Target: net10.0 (but marked with NoWarn)
5. `OtelEvents.Testing/OtelEvents.Testing.csproj` - Target: net10.0

**All Test Projects:**
1. `OtelEvents.Analyzers.Tests/OtelEvents.Analyzers.Tests.csproj` - Target: net10.0, IsPackable: false
2. `OtelEvents.Causality.Tests/OtelEvents.Causality.Tests.csproj` - Target: net10.0, IsPackable: false
3. `OtelEvents.Exporter.Json.Tests/OtelEvents.Exporter.Json.Tests.csproj` - Target: net10.0, IsPackable: false
4. `OtelEvents.Schema.Tests/OtelEvents.Schema.Tests.csproj` - Target: net10.0, IsPackable: false
5. `OtelEvents.Integration.Tests/OtelEvents.Integration.Tests.csproj` - Target: net10.0, IsPackable: false (appears to be new)

---

## 4. EXISTING INTEGRATION PACK STRUCTURE PATTERNS

### Core Infrastructure Packages (OtelEvents.*)

**OtelEvents.Schema** - YAML parser & code generator
...
**OtelEvents.Exporter.Json** - AI-optimized JSON exporter
...
**OtelEvents.Testing** - Testing utilities
...
### OtelEvents.Causality Registration
...
### OtelEvents.Exporter.Json Registration
