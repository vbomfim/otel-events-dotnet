...
public class LifecycleSchemaTests
{
    ...
    // ═══════════════════════════════════════════════════════════════
    // YAML CONTENT — matches src/All.Schema/Schemas/lifecycle.all.yaml
    // ═══════════════════════════════════════════════════════════════
    ...
    public void Parse_LifecycleSchema_HasCorrectHeader()
    {
        ...
        Assert.Equal("All.Events.Lifecycle", header.Namespace);
    ...
    public void Generate_LifecycleSchema_HasCorrectNamespace()
    {
        ...
        Assert.Contains("namespace All.Events.Lifecycle;", content);
    }
    ...
    public void Generate_LifecycleSchema_EnumsHaveCorrectNamespace()
    {
        ...
        Assert.Contains("namespace All.Events.Lifecycle;", healthFile.Content);
        Assert.Contains("namespace All.Events.Lifecycle;", phaseFile.Content);
    }
