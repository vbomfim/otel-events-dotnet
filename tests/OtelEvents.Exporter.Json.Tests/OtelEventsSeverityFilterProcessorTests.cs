...
/// <summary>
/// Tests for <see cref="OtelEventsSeverityFilterProcessor"/>: severity-based log record filtering.
/// </summary>
public sealed class OtelEventsSeverityFilterProcessorTests : IDisposable
{
    ...
    public OtelEventsSeverityFilterProcessorTests()
    {
    ...
    {
        var options = new OtelEventsSeverityFilterOptions { MinSeverity = LogLevel.Information };
    ...
    {
        var options = new OtelEventsSeverityFilterOptions { MinSeverity = LogLevel.Debug };
        using var processor = new OtelEventsSeverityFilterProcessor(options, _innerProcessor);
    ...
    {
        var options = new OtelEventsSeverityFilterOptions { MinSeverity = LogLevel.Trace };
        using var processor = new OtelEventsSeverityFilterProcessor(options, _innerProcessor);
    ...
    public void EventWithLogLevelNone_IsAlwaysDropped()
    {
        ...
        var result = OtelEventsSeverityFilterProcessor.ShouldProcess(LogLevel.None, LogLevel.Trace);
    ...
    public void InvalidMinSeverity_ThrowsArgumentOutOfRangeException()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new OtelEventsSeverityFilterProcessor(options, _innerProcessor));
    }
    ...
    public void Constructor_NullOptions_ThrowsArgumentNullException()
    {
        Assert.Throws<ArgumentNullException>(() =>
            new OtelEventsSeverityFilterProcessor(null!, new InMemoryLogRecordProcessor()));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() =>
            new OtelEventsSeverityFilterProcessor(new OtelEventsSeverityFilterOptions(), null!));
    }
