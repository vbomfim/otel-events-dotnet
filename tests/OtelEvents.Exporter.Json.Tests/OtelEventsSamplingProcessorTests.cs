...
/// <summary>
/// Tests for <see cref="OtelEventsSamplingProcessor"/>: probabilistic event sampling
/// with head/tail strategies and per-event-name rate overrides.
/// </summary>
public sealed class OtelEventsSamplingProcessorTests : IDisposable
{
    ...
    public OtelEventsSamplingProcessorTests()
    {
    ...
    public void DefaultOptions_StrategyIsHead()
    {
        ...
        Assert.Equal(OtelEventsSamplingStrategy.Head, options.Strategy);
    }
    ...
    public void HeadSampling_Rate1_AllEventsPassThrough()
    {
        var options = new OtelEventsSamplingOptions
        {
            Strategy = OtelEventsSamplingStrategy.Head,
            DefaultSamplingRate = 1.0
        };
        using var processor = new OtelEventsSamplingProcessor(options, _innerProcessor);
    ...
    public void TailSampling_Rate0_ErrorsAlwaysSampled()
    {
        var options = new OtelEventsSamplingOptions
        {
            Strategy = OtelEventsSamplingStrategy.Tail,
            DefaultSamplingRate = 0.0,
    ...
    {
        var options = new OtelEventsSamplingOptions { DefaultSamplingRate = 0.42 };
        using var processor = new OtelEventsSamplingProcessor(options, _innerProcessor);
    ...
    {
        var options = new OtelEventsSamplingOptions { DefaultSamplingRate = 1.0 };
        using var processor = new OtelEventsSamplingProcessor(options, _innerProcessor);
    ...
    {
        var options = new OtelEventsSamplingOptions { DefaultSamplingRate = 0.0 };
        using var processor = new OtelEventsSamplingProcessor(options, _innerProcessor);
    ...
    public void Dispose_DisposesInnerProcessor()
    {
        ...
        var options = new OtelEventsSamplingOptions();
        var processor = new OtelEventsSamplingProcessor(options, inner);
    ...
    public void InvalidStrategy_ThrowsArgumentOutOfRangeException()
    {
        var options = new OtelEventsSamplingOptions
        {
            Strategy = (OtelEventsSamplingStrategy)999
        };

        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new OtelEventsSamplingProcessor(options, _innerProcessor));
    }
    ...
    public void Constructor_NullOptions_ThrowsArgumentNullException()
    {
        Assert.Throws<ArgumentNullException>(() =>
            new OtelEventsSamplingProcessor(null!, new InMemoryLogRecordProcessor()));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() =>
            new OtelEventsSamplingProcessor(new OtelEventsSamplingOptions(), null!));
    }
    ...
    {
        var options = new OtelEventsSamplingOptions { DefaultSamplingRate = rate };
    ...
    public async Task ConcurrentSampling_ThreadSafe()
    {
        ...
        using var processor = new OtelEventsSamplingProcessor(options, inner);
