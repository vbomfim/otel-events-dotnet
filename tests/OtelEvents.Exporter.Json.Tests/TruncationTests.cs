...
/// <summary>
/// Tests for attribute value truncation at <see cref="OtelEventsJsonExporterOptions.MaxAttributeValueLength"/>.
...
public sealed class TruncationTests
{
    ...
    {
        using var harness = new TestExporterHarness(new OtelEventsJsonExporterOptions { MaxAttributeValueLength = 100 });
