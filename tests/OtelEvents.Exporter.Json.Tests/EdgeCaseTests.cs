...
public sealed class EdgeCaseTests
{
    ...
    [Fact]
    public void AddOtelEventsJsonExporter_NullBuilder_ThrowsArgumentNullException()
    {
        Assert.Throws<ArgumentNullException>(() =>
            OtelEventsJsonExporterExtensions.AddOtelEventsJsonExporter(null!, (Action<OtelEventsJsonExporterOptions>?)null));
    }
