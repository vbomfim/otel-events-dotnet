...
/// <summary>
/// Tests for <see cref="AllSamplingExtensions"/> DI registration
/// and end-to-end pipeline sampling behavior.
/// </summary>
public sealed class AllSamplingExtensionsTests
{
    ...
    public void AddAllSampler_NullInnerProcessor_ThrowsArgumentNullException()
    {
        ...
        Assert.Throws<ArgumentNullException>(() =>
            new AllSamplingProcessor(
                new AllSamplingOptions(),
                null!));
    }
        ...
        using var loggerFactory = LoggerFactory.Create(builder =>
        {
            ...
            builder.AddOpenTelemetry(options =>
            {
                ...
                options.AddProcessor(
                    new AllSamplingProcessor(
                        new AllSamplingOptions { DefaultSamplingRate = 0.0 },
