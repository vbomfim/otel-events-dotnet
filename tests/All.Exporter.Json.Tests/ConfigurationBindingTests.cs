...
/// <summary>
/// Tests for <see cref="AllJsonExporterOptions"/> and <see cref="AllSeverityFilterOptions"/>
...
{
    // ─── AllJsonExporterOptions Binding ──────────────────────────────
    ...
    public void ExporterOptions_BindsOutputEnum_FromConfiguration()
    {
        ...
        Assert.Equal(AllJsonOutput.Stderr, options.Output);
    }
    ...
    public void ExporterOptions_BindsEnvironmentProfile_FromConfiguration()
    {
        ...
        Assert.Equal(AllEnvironmentProfile.Development, options.EnvironmentProfile);
    }
    ...
    public void ExporterOptions_BindsFilePath_FromConfiguration()
    {
        ...
        Assert.Equal(AllJsonOutput.File, options.Output);
    ...
    [Theory]
    [InlineData("Stdout", AllJsonOutput.Stdout)]
    [InlineData("Stderr", AllJsonOutput.Stderr)]
    [InlineData("File", AllJsonOutput.File)]
    public void ExporterOptions_BindsAllOutputEnumValues(string configValue, AllJsonOutput expected)
    {
    ...
    [Theory]
    [InlineData("Development", AllEnvironmentProfile.Development)]
    [InlineData("Staging", AllEnvironmentProfile.Staging)]
    [InlineData("Production", AllEnvironmentProfile.Production)]
    public void ExporterOptions_BindsAllEnvironmentProfileValues(
        string configValue, AllEnvironmentProfile expected)
    {
    ...
    // ─── AllSeverityFilterOptions Binding ────────────────────────────
    ...
    public void AutoDetects_Development_FromAspNetCoreEnvironment()
    {
        ...
        Assert.Equal(AllEnvironmentProfile.Development, result);
    }
    ...
    public void AutoDetects_Staging_FromDotNetEnvironment()
    {
        ...
        Assert.Equal(AllEnvironmentProfile.Staging, result);
    }
    ...
    public void AutoDetects_Production_FromAspNetCoreEnvironment()
    {
        ...
        Assert.Equal(AllEnvironmentProfile.Production, result);
    }
    ...
    [Fact]
    public void AddAllJsonExporter_WithConfiguration_RegistersPipeline()
    {
        // Arrange
        var config = BuildConfig(("All:Exporter:Output", "Stderr"));
        ...
        services.AddOpenTelemetry()
            .WithLogging(builder =>
            {
                builder.AddAllJsonExporter(config);
            });
    ...
    [Fact]
    public void AddAllJsonExporter_NullConfiguration_ThrowsArgumentNullException()
    {
        var services = new ServiceCollection();
        services.AddOpenTelemetry()
            .WithLogging(builder =>
            {
                Assert.Throws<ArgumentNullException>(() =>
                    builder.AddAllJsonExporter((IConfiguration)null!));
            });
    }
    ...
    [Fact]
    public void AddAllJsonExporter_NullBuilder_WithConfiguration_ThrowsArgumentNullException()
    {
        LoggerProviderBuilder? nullBuilder = null;
        var config = BuildConfig();

        Assert.Throws<ArgumentNullException>(() =>
            nullBuilder!.AddAllJsonExporter(config));
    }
    ...
    public void FullConfiguration_BindsAllScalarProperties()
    {
        ...
        Assert.Equal("2.0.0", options.SchemaVersion);
        Assert.Equal(AllEnvironmentProfile.Staging, options.EnvironmentProfile);
    ...
    /// <summary>
    /// Binds <see cref="AllJsonExporterOptions"/> from the "All:Exporter" section.
    /// Mirrors the production binding logic.
    /// </summary>
    private static AllJsonExporterOptions BindExporterOptions(IConfiguration config)
    {
    ...
    /// <summary>
    /// Binds <see cref="AllJsonExporterOptions"/> with EnvironmentProfile auto-detection.
    /// Mirrors the production DI extension logic.
    /// </summary>
    private static AllJsonExporterOptions BindExporterOptionsWithAutoDetection(
    ...
    /// <summary>
    /// Binds <see cref="AllSeverityFilterOptions"/> from the "All:Filter" section.
    /// Mirrors the production binding logic.
    /// </summary>
    private static AllSeverityFilterOptions BindFilterOptions(IConfiguration config)
    {
