...
/// <summary>
/// Tests for <see cref="AllRateLimitProcessor"/>: per-event-category rate limiting.
/// </summary>
public sealed class AllRateLimitProcessorTests : IDisposable
{
    ...
    public AllRateLimitProcessorTests()
    {
    ...
    {
        var options = new AllRateLimitOptions { DefaultMaxEventsPerWindow = 0 };
        using var processor = new AllRateLimitProcessor(options, _innerProcessor);
    ...
    public void EventsExceedingDefaultLimit_AreDropped()
    {
        ...
        var options = new AllRateLimitOptions { DefaultMaxEventsPerWindow = 3 };
        using var processor = new AllRateLimitProcessor(options, _innerProcessor, timeProvider);
    ...
    {
        var timeProvider = new FakeTimeProvider();
        var options = new AllRateLimitOptions { DefaultMaxEventsPerWindow = 10 };
        using var processor = new AllRateLimitProcessor(options, _innerProcessor, timeProvider);
    ...
    {
        var timeProvider = new FakeTimeProvider();
        var options = new AllRateLimitOptions { DefaultMaxEventsPerWindow = 1 };
        using var processor = new AllRateLimitProcessor(options, _innerProcessor, timeProvider);
    ...
    {
        var timeProvider = new FakeTimeProvider();
        var options = new AllRateLimitOptions { DefaultMaxEventsPerWindow = 5 };
        using var processor = new AllRateLimitProcessor(options, _innerProcessor, timeProvider);
    ...
    {
        var timeProvider = new FakeTimeProvider();
        var options = new AllRateLimitOptions { DefaultMaxEventsPerWindow = 100 };
        var threadSafeInner = new ThreadSafeLogRecordProcessor();
        using var processor = new AllRateLimitProcessor(options, threadSafeInner, timeProvider);
    ...
    {
        var timeProvider = new FakeTimeProvider();
        var options = new AllRateLimitOptions { DefaultMaxEventsPerWindow = 50 };
        var threadSafeInner = new ThreadSafeLogRecordProcessor();
        using var processor = new AllRateLimitProcessor(options, threadSafeInner, timeProvider);
    ...
    public void NegativeDefaultMaxEventsPerWindow_ThrowsArgumentOutOfRangeException()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new AllRateLimitProcessor(options, _innerProcessor));
    }

    [Fact]
    public void ZeroOrNegativeWindow_ThrowsArgumentOutOfRangeException()
    {
        var options = new AllRateLimitOptions { Window = TimeSpan.Zero };
    ...
    {
        var options = new AllRateLimitOptions { Window = TimeSpan.FromSeconds(-1) };
    ...
    public void Constructor_NullOptions_ThrowsArgumentNullException()
    {
        Assert.Throws<ArgumentNullException>(() =>
            new AllRateLimitProcessor(null!, new InMemoryLogRecordProcessor()));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() =>
            new AllRateLimitProcessor(new AllRateLimitOptions(), null!));
    }
    ...
    {
        var options = new AllRateLimitOptions { DefaultMaxEventsPerWindow = 42 };
        using var processor = new AllRateLimitProcessor(options, _innerProcessor);
