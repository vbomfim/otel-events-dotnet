...
/// <summary>
/// Tests for <see cref="AllRateLimitExtensions"/> DI registration
/// and end-to-end pipeline rate limiting behavior.
/// </summary>
public sealed class AllRateLimitExtensionsTests
{
    ...
    public void AddAllRateLimiter_NullInnerProcessor_ThrowsArgumentNullException()
    {
        ...
        Assert.Throws<ArgumentNullException>(() =>
            new AllRateLimitProcessor(
                new AllRateLimitOptions(),
                null!));
    }
        ...
        using var loggerFactory = LoggerFactory.Create(builder =>
        {
            ...
            builder.AddOpenTelemetry(options =>
            {
                ...
                options.AddProcessor(
                    new AllRateLimitProcessor(
                        new AllRateLimitOptions { DefaultMaxEventsPerWindow = 2 },
